...
Word("20250804153153.pdf")
os.replace(
    os.path.join(SCAN_FOLDER, "20250804153153.pdf"),
    os.path.join(ORIGINAL_FOLDER, "20250804153153.pdf"),
)
"""
...
for filename in os.listdir(SCAN_FOLDER):
    ...
    Word(filename)
    os.replace(file, os.path.join(ORIGINAL_FOLDER, filename))
"""
